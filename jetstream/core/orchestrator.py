...
class Driver:
  ...
  def __init__(
    ...
    if enable_warmup:
      self._prefill_engines = [engine_api.WarmedUpEngine() for pe in self._prefill_engines]
      self._generate_engines = [engine_api.WarmedUpEngine() for ge in self._generate_engines]
